        ...
        <div class="bg-primary-500">
            ...
            <div class="flex items-start justify-center text-center text-grey-lightest mt-24">
                ...
                <div class="md:w-1/5 xs:w-1/3">
                    ...
                    <div class="flex flex-col items-center font-thin text-sm opacity-50 mt-4">
                        <a href="#" class="no-underline text-grey-lightest">Apple App Store <span
                                class="md:inline-block xs:hidden">(iOS)</span></a>
                        <a href="#" class="no-underline text-grey-lightest mt-2">Google Play Store <span
                                class="md:inline-block xs:hidden">(Android)</span></a>
                    </div>
